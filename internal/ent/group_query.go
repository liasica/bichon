...
func (gq *GroupQuery) QueryMessages() *MessageQuery {
	query := &MessageQuery{config: gq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := gq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (gq *GroupQuery) WithMessages(opts ...func(*MessageQuery)) *GroupQuery {
	query := &MessageQuery{config: gq.config}
	for _, opt := range opts {
		opt(query)
	}
	gq.withMessages = query
	return gq
}
...
func (gq *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := gq.withMessages; query != nil {
		if err := gq.loadMessages(ctx, query, nodes,
			func(n *Group) { n.Edges.Messages = []*Message{} },
			func(n *Group, e *Message) { n.Edges.Messages = append(n.Edges.Messages, e) }); err != nil {
			return nil, err
		}
	}
...
func (gq *GroupQuery) loadMessages(ctx context.Context, query *MessageQuery, nodes []*Group, init func(*Group), assign func(*Group, *Message)) error {
	...
	query.Where(predicate.Message(func(s *sql.Selector) {
		s.Where(sql.InValues(group.MessagesColumn, fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (gq *GroupQuery) loadGroupMembers(ctx context.Context, query *GroupMemberQuery, nodes []*Group, init func(*Group), assign func(*Group, *GroupMember)) error {
	...
	query.Where(predicate.GroupMember(func(s *sql.Selector) {
		s.Where(sql.InValues(group.GroupMembersColumn, fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
